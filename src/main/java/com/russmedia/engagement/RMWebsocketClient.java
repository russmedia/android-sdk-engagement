...
public class RMWebsocketClient extends WebSocketClient {
    ...
    public RMWebsocketClient(URI serverUri, Draft_6455 protocolDraft, Map<String, String> httpHeaders, int connectTimeout, EngagementEngine engine, RMWebsocketCallbacks callback) {
    ...
    public void close(String reason) {
        ...
        super.closeConnection(-1, reason);
    }
